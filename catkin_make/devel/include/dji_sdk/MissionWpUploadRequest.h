// Generated by gencpp from file dji_sdk/MissionWpUploadRequest.msg
// DO NOT EDIT!


#ifndef DJI_SDK_MESSAGE_MISSIONWPUPLOADREQUEST_H
#define DJI_SDK_MESSAGE_MISSIONWPUPLOADREQUEST_H
...
struct MissionWpUploadRequest_
{
  ...
  typedef boost::shared_ptr< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> const> ConstPtr;

}; // struct MissionWpUploadRequest_

typedef ::dji_sdk::MissionWpUploadRequest_<std::allocator<void> > MissionWpUploadRequest;

typedef boost::shared_ptr< ::dji_sdk::MissionWpUploadRequest > MissionWpUploadRequestPtr;
typedef boost::shared_ptr< ::dji_sdk::MissionWpUploadRequest const> MissionWpUploadRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x412556517acb90aaULL;
  static const uint64_t static_value2 = 0x4c3e713fbb867865ULL;
};

template<class ContainerAllocator>
struct DataType< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dji_sdk::MissionWpUploadRequest_<ContainerAllocator>& v)
  {
...
#endif // DJI_SDK_MESSAGE_MISSIONWPUPLOADREQUEST_H
